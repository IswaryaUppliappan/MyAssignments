...
public class MenuLeafGround {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement order1 = driver.findElement(By.xpath("//span[text()='View']"));
		builder.moveToElement(order1).perform();
		...
		driver.findElement(By.xpath("//li[contains(@class,'ui-tabmenuitem ui-state-default')]//a")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[text()='Members']")).click();
		// Slide menu
